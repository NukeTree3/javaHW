...
public class telephonenote {
    ...
    public static void main(String[] args){
        ...
        //тестовые контакты
        map.put("name1", "45678987");
        map.put("name2", "98736254, 5625266, 5642572");
        map.put("name3", "63773773, 4567878");
        map.put("name4", "87655535");

        Scanner scanner = new Scanner(System.in);
        while(true){
            System.out.println("Укажете действие (1-добавление, 2-вывод всех контактов, 3-удаление контакта)");
